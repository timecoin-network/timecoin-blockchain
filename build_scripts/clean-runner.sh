...
rm -rf ../venv || true
rm -rf venv || true
rm -rf timecoin_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf timecoin-blockchain-gui/build || true
rm -rf timecoin-blockchain-gui/daemon || true
rm -rf timecoin-blockchain-gui/node_modules || true
rm timecoin-blockchain-gui/temp.json || true
( cd "$PWD/timecoin-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
...
npm uninstall -g @timecoincrypto/notarize-cli || true
