...
from timecoin.pools.pool_config import PoolWalletConfig
from timecoin.util.config import load_config, save_config, create_default_timecoin_config
...
def test_pool_config():
    ...
    create_default_timecoin_config(test_root, ["config.yaml"])
