...
wallet_program_files = set(
    [
        "timecoin/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "timecoin/wallet/puzzles/cc.clvm",
        "timecoin/wallet/puzzles/chialisp_deserialisation.clvm",
        "timecoin/wallet/puzzles/rom_bootstrap_generator.clvm",
        "timecoin/wallet/puzzles/generator_for_single_coin.clvm",
        "timecoin/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "timecoin/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "timecoin/wallet/puzzles/lock.inner.puzzle.clvm",
        "timecoin/wallet/puzzles/p2_conditions.clvm",
        "timecoin/wallet/puzzles/p2_delegated_conditions.clvm",
        "timecoin/wallet/puzzles/p2_delegated_puzzle.clvm",
        "timecoin/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "timecoin/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "timecoin/wallet/puzzles/p2_puzzle_hash.clvm",
        "timecoin/wallet/puzzles/rl_aggregation.clvm",
        "timecoin/wallet/puzzles/rl.clvm",
        "timecoin/wallet/puzzles/sha256tree_module.clvm",
        "timecoin/wallet/puzzles/singleton_top_layer.clvm",
        "timecoin/wallet/puzzles/did_innerpuz.clvm",
        "timecoin/wallet/puzzles/decompress_puzzle.clvm",
        "timecoin/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "timecoin/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "timecoin/wallet/puzzles/block_program_zero.clvm",
        "timecoin/wallet/puzzles/test_generator_deserialize.clvm",
        "timecoin/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "timecoin/wallet/puzzles/p2_singleton.clvm",
        "timecoin/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "timecoin/wallet/puzzles/pool_member_innerpuz.clvm",
        "timecoin/wallet/puzzles/singleton_launcher.clvm",
        "timecoin/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["timecoin/wallet/puzzles/create-lock-puzzlehash.clvm", "timecoin/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "timecoin/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to timecoin/wallet/puzzles, but not added to `wallet_program_files`
        """
