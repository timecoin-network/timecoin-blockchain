...
from timecoin.plotting.util import stream_plot_info_ph, stream_plot_info_pk, PlotRefreshResult, PlotRefreshEvents
from timecoin.plotting.manager import PlotManager
from timecoin.protocols import farmer_protocol
from timecoin.rpc.farmer_rpc_api import FarmerRpcApi
from timecoin.rpc.farmer_rpc_client import FarmerRpcClient
from timecoin.rpc.harvester_rpc_api import HarvesterRpcApi
from timecoin.rpc.harvester_rpc_client import HarvesterRpcClient
from timecoin.rpc.rpc_server import start_rpc_server
...
from timecoin.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "timecoin"), encode_puzzle_hash(new_ph_2, "timecoin"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "timecoin"))
            ...
            assert config["farmer"]["timecoin_target_address"] == encode_puzzle_hash(new_ph, "timecoin")
            assert config["pool"]["timecoin_target_address"] == encode_puzzle_hash(new_ph_3, "timecoin")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "timecoin")
