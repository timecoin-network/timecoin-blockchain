...
from timecoin.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "56644"
            # testnet_introducer = "beta1_introducer.timecoincrypto.net"
            # testnet_dns_introducer = "dns-introducer-testnet7.timecoincrypto.net"
            testnet = "testnet"
            ...
            mainnet_port = "56444"
            # mainnet_introducer = "introducer.timecoincrypto.net"
            # mainnet_dns_introducer = "dns-introducer.timecoincrypto.net"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running timecoin services for changes to take effect")
