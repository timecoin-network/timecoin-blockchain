...
from timecoin.consensus.block_body_validation import validate_block_body
from timecoin.consensus.block_header_validation import validate_finished_header_block, validate_unfinished_header_block
...
from timecoin.consensus.multiprocess_validation import (
    PreValidationResult,
    _run_generator,
    pre_validate_blocks_multiprocessing,
)
from timecoin.consensus.pos_quality import UI_ACTUAL_SPACE_CONSTANT_FACTOR
...
from timecoin.full_node.mempool_check_conditions import get_name_puzzle_conditions
...
from timecoin.types.blockchain_format.vdf import VDFInfo
...
from timecoin.types.generator_types import BlockGenerator, GeneratorArg
from timecoin.types.header_block import HeaderBlock
from timecoin.types.unfinished_block import UnfinishedBlock
from timecoin.types.unfinished_header_block import UnfinishedHeaderBlock
from timecoin.types.weight_proof import SubEpochChallengeSegment
from timecoin.util.errors import ConsensusError, Err
from timecoin.util.generator_tools import get_block_header, tx_removals_and_additions
from timecoin.util.ints import uint16, uint32, uint64, uint128
from timecoin.util.streamable import recurse_jsonify
    ...
    async def get_farmer_difficulty_coeff(
        ...
        if minimal_staking == 0 or staking < minimal_staking:
            ...
            if blocks == 0:
                ...
                # multiple 1000 to keep same scale as timecoin
