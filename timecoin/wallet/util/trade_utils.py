...
from timecoin.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "timecoin" in cc_discrepancies:
                    cc_discrepancies["timecoin"] = cc_discrepancies["timecoin"] + diff
                else:
                    cc_discrepancies["timecoin"] = diff
