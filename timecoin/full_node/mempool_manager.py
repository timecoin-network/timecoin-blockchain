...
from timecoin.consensus.cost_calculator import NPCResult, calculate_cost_of_program
from timecoin.full_node.bundle_tools import simple_solution_generator
from timecoin.full_node.coin_store import CoinStore
from timecoin.full_node.mempool import Mempool
from timecoin.full_node.mempool_check_conditions import mempool_check_conditions_dict, get_name_puzzle_conditions
...
from timecoin.util.cached_bls import LOCAL_CACHE
from timecoin.util.clvm import int_from_bytes
from timecoin.util.condition_tools import pkm_pairs
from timecoin.util.errors import Err, ValidationError
from timecoin.util.generator_tools import additions_for_npc
...
class MempoolManager:
    def __init__(self, coin_store: CoinStore, consensus_constants: ConsensusConstants):
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 TIMECOIN per block, or about 0.00005 TIMECOIN for two
        # spends.
