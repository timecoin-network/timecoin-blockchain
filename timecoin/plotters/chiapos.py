"""
NOTE: This contains duplicate code from `timecoin.cmds.plots`.
After `timecoin plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Timecoin Proof of Space", "version": chiapos_version, "installed": True}
...
def plot_timecoin(args, root_path):
