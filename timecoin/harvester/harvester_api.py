...
from timecoin.harvester.harvester import Harvester
from timecoin.plotting.util import PlotInfo, parse_plot_info
from timecoin.protocols import harvester_protocol
from timecoin.protocols.farmer_protocol import FarmingInfo
from timecoin.protocols.harvester_protocol import Plot
from timecoin.protocols.protocol_message_types import ProtocolMessageTypes
from timecoin.server.outbound_message import make_msg
...
from timecoin.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSTimecoinConnection
    ):
        """
