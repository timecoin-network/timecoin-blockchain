...
from timecoin.daemon.server import service_launch_lock_path, singleton
from timecoin.server.ssl_context import timecoin_ssl_ca_paths, private_ssl_ca_paths
...
class Service:
    def __init__(
        ...
        proctitle_name = f"timecoin_{service_name}"
        ...
        timecoin_ca_crt, timecoin_ca_key = timecoin_ssl_ca_paths(root_path, self.config)
        inbound_rlp = self.config.get("inbound_rate_limit_percent")
        outbound_rlp = self.config.get("outbound_rate_limit_percent")
        assert inbound_rlp and outbound_rlp
        self._server = TimecoinServer(
            advertised_port,
            node,
            peer_api,
            node_type,
            ...
            (timecoin_ca_crt, timecoin_ca_key),
    ...
    async def wait_closed(self) -> None:
        ...
        self._log.info("Waiting for TimecoinServer to be closed")
