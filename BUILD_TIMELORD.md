...
required to run a [Timelord](https://github.com/Timecoin-Network/timecoin-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Timecoin-Network/timecoin-blockchain/blob/main/install-timelord.sh)
