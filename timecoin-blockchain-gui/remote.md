...
````bash
~/.timecoin/<currentversion>/config/ssl/daemon/private_daemon.crt
~/.timecoin/<currentversion>/config/ssl/daemon/private_daemon.key
````
...
````bash
~/.timecoin/<currentversion>/config/ssl/ui/
~/.timecoin/<currentversion>/config/ssl/ui/
````
