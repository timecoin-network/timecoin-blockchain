...
import { Flex, Form, InputBase, Loading, More, Amount } from '@timecoin/core';
...
import { timecoin_to_mojo, mojo_to_timecoin} from '../../util/timecoin';
...
export default function StakeMain() {
    ...
    function dealSearchResult(records:any[]):string {
      ...
      let total_timecoin: number = mojo_to_timecoin(total);
      return "Staking Balance: " + total_timecoin.toLocaleString();
    }
    ...
    return (
        <Flex flexDirection="column" gap={3}>
          ...
          Please select your staking address and send TIMECOIN to it.
          </Typography>
