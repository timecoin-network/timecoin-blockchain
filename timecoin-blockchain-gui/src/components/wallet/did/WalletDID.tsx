...
import { AlertDialog, Card, Flex, Loading, Dropzone } from '@timecoin/core';
import {
...
import { mojo_to_timecoin_string } from '../../../util/timecoin';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_timecoin_string(props.balance)} TTIMECOIN
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const CreateAttest = (props) => {
  ...
  function createAttestPacket() {
    ...
    if (address.substring(0, 12) === 'timecoin_addr://') {
...
const CashoutCard = (props) => {
  ...
  function cashout() {
    ...
    if (puzzlehash.slice(0, 12) === 'timecoin_addr://') {
