...
import { Flex, Form, InputBase } from '@timecoin/core';
  ...
  return (
    <Flex flexDirection="column" gap={3}>
      ...
      <Typography variant="body1" color="textSecondary">
        Enter your Timecoin pool contract address and NFT Launcher ID to recover the missing TIMECOIN from your plot NFT.
      </Typography>
