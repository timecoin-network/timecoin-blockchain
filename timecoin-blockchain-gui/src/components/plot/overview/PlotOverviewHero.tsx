...
import { CardHero, Flex, Link } from '@timecoin/core';
import { PlotHero as PlotHeroIcon } from '@timecoin/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Timecoin. '
              }
              <Link
                target="_blank"
                href="https://github.com/Timecoin-Network/timecoin-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
