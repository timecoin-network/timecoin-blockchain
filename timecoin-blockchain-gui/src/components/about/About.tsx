...
import icon from '../../assets/img/timecoin_circle.svg';
...
const url = 'https://www.timecoincrypto.net';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2022 Timecoin Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Timecoin-Network/timecoin-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
