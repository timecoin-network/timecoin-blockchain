...
export const defaultPlotter = (): Plotter => {
  return {
    displayName: "Timecoin Proof of Space",
    options: optionsForPlotter(PlotterName.TIMECOINPOS),
    defaults: defaultsForPlotter(PlotterName.TIMECOINPOS),
...
const initialState: PlotterConfigurationState = {
  availablePlotters: {
    [PlotterName.TIMECOINPOS]: defaultPlotter(),
  },
