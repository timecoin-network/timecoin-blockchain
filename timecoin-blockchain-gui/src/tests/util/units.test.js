...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of timecoin', () => {
      const result = units.getUnit('timecoin');
    ...
    it('gets unit of timecoin using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of timecoin', () => {
      const result = units.getDisplay('timecoin');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('timecoin', 9);

      const result = units.getUnit('timecoin');

      expect(result).toEqual(9);

      units.setUnit('timecoin', 1);
    });
  });
  describe('#setDisplay', () => {
    ...
    it('updates an existing display', () => {
      units.setDisplay('timecoin', {
        format: '{amount} TTIMECOIN',
        fractionDigits: 0,
      });
