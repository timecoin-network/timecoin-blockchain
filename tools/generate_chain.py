...
@click.command()
@click.option("--length", type=int, default=3000, required=False, help="the number of blocks to generate")
@click.option(
    "--fill-rate",
    type=int,
    default=100,
            ...
            while True:
                with enable_profiler(profile, b.height):
                    ...
                    print(
                        ...
                        f"timestamp: {(b.foliage_transaction_block.timestamp - prev_tx_block.foliage_transaction_block.timestamp) if prev_tx_block is not None else 0} "
